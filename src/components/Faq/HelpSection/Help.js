...
const Help = () => {
    return (
      <section className="staking-help">
        <div className="wrapper MuiContainer-root-81 MuiContainer-maxWidthLg-87">
          <h2 className="main__title blog">Need Help?</h2>
          <p className="main__text">
            Still have any questions? Join our global community on Telegram or
            Discord to get support from pro users, traders and investors.
          </p>
          <div className="staking-help__social">
            ...
            <a
              target="_blank"
              rel="noreferrer noopener"
              href="https://discord.com/invite/CTcKpPc"
              className="staking-help__social-item"
            >
              <svg
                width={30}
