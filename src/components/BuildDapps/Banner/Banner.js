    ...
    return (
      <section className="dapps-hero">
        <div className="wrapper">
          <img
            src="https://velas.com/assets/img/dapps/light/hero.webp"
            data-theme-src="/assets/img/dapps/dark/hero.webp"
            data-rjs={2}
            alt="hero"
            className="main-decor dapps-hero__img"
          />
          <div className="dapps-hero__content">
            <h1 className="main__title">Develop dApps using Velas</h1>
            <p className="main__text">
              Use the fastest EVM/eBPF hybrid chain out there to create sturdy
              decentralized apps
            </p>
