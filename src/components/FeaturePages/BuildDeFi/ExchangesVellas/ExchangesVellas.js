...
const ExchangesVellas = () => {
    return (
      <section className="exchanges-velas">
        <img
          data-src="https://velas.com/assets/img/exchanges/light/token-bg.webp"
          data-theme-src="https://velas.com/assets/img/exchanges/dark/token-bg.webp"
          alt="bg"
          className="exchanges-velas__bg lozad"
          src="https://velas.com/assets/img/exchanges/light/token-bg.webp"
          data-loaded="true"
        />
        <div className="wrapper">
          <div className="exchanges-velas__content">
            <h2 className="main__title">
              Add Velas ($VLX) token to your exchange or wallet
            </h2>
            <p className="main__text">
              You may easily add Velas ($VLX) token to your DEX using our
              documentation portal. If you are stuck, use the 'get help' button.
            </p>
            <div className="exchanges-velas__content-row">
              <a
                target="_blank"
                href="https://docs.velas.com/integrations/exchange"
...
export default ExchangesVellas;
