    ...
    return (
      <section className="dapps-hero defi">
        <div className="wrapper">
          <img
            src="https://velas.com/assets/img/defi/light/hero.webp"
            data-theme-src="https://velas.com/assets/img/defi/dark/hero.webp"
            data-rjs={2}
            alt="hero"
            className="main-decor defi-hero__img"
          />
          <div className="dapps-hero__content">
            <h1 className="main__title">Develop DeFi projects on Velas</h1>
            <p className="main__text">
              Create DeFi solutions that secure and streamline finance via the
              fastest blockchain powers.
            </p>
