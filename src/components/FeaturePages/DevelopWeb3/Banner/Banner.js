    ...
    return (
      <section className="dapps-hero defi">
        <div className="wrapper">
          <img
            src="https://velas.com/assets/img/web3/light/hero.webp"
            data-theme-src="https://velas.com/assets/img/web3/dark/hero.webp"
            data-rjs={2}
            alt="hero"
            className="main-decor web3-hero__img"
          />
          <div className="dapps-hero__content long">
            <h1 className="main__title">
              Develop Web 3.0 projects based on Velas
            </h1>
            <p className="main__text">
              Velas is the fastest EVM blockchain with the lowest fees that
              works as a perfect foundation for any type of Web 3.0 project
            </p>
