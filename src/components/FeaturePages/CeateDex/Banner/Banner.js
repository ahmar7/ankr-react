    ...
    return (
      <section className="dapps-hero defi ">
        <div className="wrapper">
          <img
            src="https://velas.com/assets/img/dex/light/hero.webp"
            data-theme-src="/assets/img/dex/dark/hero.webp"
            data-rjs={2}
            alt="hero"
            className="main-decor dex-hero__img"
          />
          <div className="dapps-hero__content">
            <h1 className="main__title">Develop DEX projects using Velas</h1>
            <p className="main__text">
              Put the fastest EVM/eBPF Hybrid Chain at the core of Decentralized
              Exchange solutions that outrun the market.
            </p>
