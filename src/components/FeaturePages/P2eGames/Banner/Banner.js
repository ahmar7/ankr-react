    ...
    return (
      <section className="dapps-hero defi">
        <div className="wrapper">
          <img
            src="https://velas.com/assets/img/p2e/light/bubles.webp"
            data-theme-src="https://velas.com/assets/img/p2e/dark/bubles.webp"
            alt="hero"
            className="main-decor p2e-hero__img-1"
          />
          <img
            src="https://velas.com/assets/img/p2e/light/hero.webp"
            data-theme-src="https://velas.com/assets/img/p2e/dark/hero.webp"
            data-rjs={2}
            alt="hero"
            className="main-decor p2e-hero__img"
          />
          <div className="dapps-hero__content">
            <h1 className="main__title">Develop P2E games powered by Velas</h1>
            <p className="main__text">
              Put the most rapid EVM/eBPF blockchain available in the foundation
              of your P2E games.
            </p>
