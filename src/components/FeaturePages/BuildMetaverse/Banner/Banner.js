    ...
    return (
      <section className="dapps-hero defi">
        <div className="wrapper">
          <img
            src="https://velas.com/assets/img/metaverse/light/gradient.svg"
            data-theme-src="https://velas.com/assets/img/metaverse/dark/gradient.svg"
            alt="hero"
            className="main-decor metaverse-hero__img-1"
          />
          <img
            src="https://velas.com/assets/img/metaverse/light/hero.webp"
            data-theme-src="https://velas.com/assets/img/metaverse/dark/hero.webp"
            data-rjs={2}
            alt="hero"
            className="main-decor metaverse-hero__img"
          />
          <div className="dapps-hero__content long">
            <h1 className="main__title">Build Metaverses using Velas</h1>
            <p className="main__text">
              Use the fastest EVM/eBPF blockchain out there to power immersive
              metaverses of any scale
            </p>
