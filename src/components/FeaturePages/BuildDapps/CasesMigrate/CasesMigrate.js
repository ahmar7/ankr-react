        ...
        <div className="wrapper">
          <div className="cases-migrate__content">
            ...
            <p className="main__text">
              Velas EVM offers simple migration or integration of Velas
              capabilities by changing a single line of code:
            </p>
            <pre className="blog-page__code">
              <code className="language-javascript hljs">
                web3 = <span className="hljs-keyword">new</span>{" "}
                <span className="hljs-title class_">Web3</span>(
                <span className="hljs-keyword">new</span>{" "}
                <span className="hljs-title class_">Web3</span>.
                <span className="hljs-property">providers</span>.
                <span className="hljs-title class_">HttpProvider</span>(’
                <span className="hljs-attr">https</span>:
                <span className="hljs-comment">
                  // evmexplorer.velas.com/rpc’));
                </span>
              </code>
            </pre>
            <a
              target="_blank"
              href="https://docs.velas.com/evm"
