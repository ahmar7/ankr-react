...
const Header = () => {
  ...
  return (
    <>
      <div className={fullFloat ? "no-shadow" : ""}>
                  ...
                  >
                    ...
                    <div className="float-dv">
                      ...
                      <div className="flex-row">
                        ...
                        <Link to="/node-provider" className="individual-link">
                          <div className="icon">
                            <svg
                              width={24}
                              height={24}
                            ...
                            <span className="MuiButton-label-107">
                              ...
                              <div className="MuiBox-root-2943 jss2959">
                                ...
                                <p className="MuiTypography-root-134 jss2942 MuiTypography-body1-136">
                                  Ankr’s contributions take BNB Chain to the
                                  next level.
                                </p>
                              </div>
                            </span>
                          ...
                          >
                            <span className="MuiButton-label-107">
                              ...
                              <div className="MuiBox-root-2943 jss2961">
                                ...
                                <p className="MuiTypography-root-134 jss2942 MuiTypography-body1-136">
                                  Serving up a multi-chain connection for the
                                  DeFi chefs at SushiSwap.
                                </p>
                              </div>
                            </span>
                          </a>
                      ...
                      <div className="flex-row">
                        <a href="#" className="individual-link">
                          ...
                          <div className="link-txt">
                            <h3>EVM</h3>
                            <p>
                              Move your dApps from Ethereum to Velas in one
                              click
                            </p>
                          </div>
                        </a>
                      ...
                      <a href="" className="flex-row flex-link flex-alter">
                        <div className="individual-link">
                          ...
                          <div className="link-txt">
                            <h3>Ecosystem</h3>
                            <p>
                              Discover top projects and dApps built on Velas
                            </p>
                          </div>
                        </div>
                        <div className="new-arrow">
                      ...
                      <div className="flex-row">
                        <a href="#" className="individual-link">
                          ...
                          <div className="link-txt">
                            <h3>Blog</h3>
                            <p>
                              Keep in tune with the latest Velas news and
                              updates
                            </p>
                          </div>
                        </a>
                      ...
                      <a href="" className="flex-row flex-link flex-alter">
                        <div className="individual-link">
                          ...
                          <div className="link-txt">
                            ...
                            <p>
                              Get to know where to buy, sell, and store your
                              $VLX
                            </p>
                          </div>
                        </div>
