...
const Header = () => {
  return (
    <header
      className="MuiPaper-root-28 MuiAppBar-root-17 MuiAppBar-positionFixed-18 MuiAppBar-colorPrimary-24 jss8 jss11 mui-fixed MuiPaper-elevation4-35"
      ...
      <div className="MuiContainer-root-81 MuiContainer-maxWidthLg-87">
        <div className="jss89 jss16">
          <button
            ...
            type="button"
          >
            <span className="__packageName__-MuiIconButton-label">
              <svg
                width={24}
                height={24}
                fill="none"
